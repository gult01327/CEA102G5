...
<ul>
  ...
  <li>
    <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/commodity/com.do" >
        <b>輸入商品編號 (如1):</b>
  ...
  <li>
  <FORM method="post" action="<%=request.getContextPath()%>/commodity_category/comc.do" >
...
<ul>  
  <li>   
    <FORM METHOD="post" ACTION="<%=request.getContextPath()%>/commodity/com.do" name="form1">
