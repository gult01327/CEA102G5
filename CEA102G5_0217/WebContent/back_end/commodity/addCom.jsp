...
<table id="table-1">
	<tr><td>
		 ...
		 <h4><a href="comSelectPage.jsp"><img src="<%=request.getContextPath() %>/resource/images/food.jpg" width="100" height="100" border="0">回首頁</a></h4>
	</td></tr>
</table>
...
<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/commodity/com.do" name="form1" enctype="multipart/form-data">
<table>
